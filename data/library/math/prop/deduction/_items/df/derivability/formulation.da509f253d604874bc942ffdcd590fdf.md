...
Formulas $A$ and $B$ are **proof-theoretically equivalent** when $A\vdash B$ and $B\vdash A$. This is a syntactic notion. Its agreement with @[logical equivalence]math:prop:semantics:df:logical-equivalence requires soundness and completeness; it is not true merely by notation.
