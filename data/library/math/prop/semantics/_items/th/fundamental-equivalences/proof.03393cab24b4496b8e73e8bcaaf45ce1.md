...
The identity and domination laws follow immediately by fixing the constant input at $1$ or $0$. Finally, exactly one of $a$ and $1-a$ is $1$, so excluded middle always has value $1$ and a contradiction always has value $0$. Since the valuation was arbitrary, every displayed pair is @[logically equivalent]math:prop:semantics:df:logical-equivalence.
