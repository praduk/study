...
The organization was independently synthesized after inspecting four complementary, authoritative course benchmarks: Tim Button and the Open Logic Project's [Set Theory: An Open Introduction](https://st.openlogicproject.org/); Richard Zach and the Open Logic Project's [Sets, Logic, Computation](https://slc.openlogicproject.org/); Yiannis Moschovakis's UCLA [M114S Introduction to Set Theory](https://math.ucla.edu/~ynm/m114s.1.20w/); and the University of Cambridge [Foundations preparation guide](https://www.maths.cam.ac.uk/postgrad/part-iii/prospective/preparation/resources/foundations). Patrick Lutz's detailed [introductory set-theory lecture sequence and exams](https://math.berkeley.edu/~pglutz/114snotes.html) provided a second first-course sequencing check. The prose, theorem statements, proofs, and solutions here are newly written rather than copied from those sources.
