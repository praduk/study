For a smooth positive refractive index $n(x)$ in a stationary isotropic medium at a fixed frequency, geometrical optics models rays by stationary paths of

$$
\mathcal L[\gamma]=\int_\gamma n(x)\,ds
$$
