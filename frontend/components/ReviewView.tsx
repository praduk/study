      ...
      <main className="review-stage">
        ...
        {!revealed ? (
          ...
          <section className="feedback-panel">
            ...
            {error && <div className="form-error" role="alert">{error}</div>}
            <p className="scheduler-disclosure"><RotateCcw size={13} /> “Again” returns later in this session; later spacing adapts to this outcome. The exact interval formula is a product heuristic, not settled science.</p>
          </section>
        )}
      </main>
    </div>
